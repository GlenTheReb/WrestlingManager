...
- Match and angle presentation remains simulation-driven. Smart arena lighting, effects, scene cards,
  crowd state and commentary lead through a complete text/2.5D viewer. PD-132 additionally permits a
  conditional original PlayCanvas Engine v2 retro 3D broadcast expansion through `@playcanvas/react`
  after a successful WebGL2/60 FPS prototype; it is
  never required for simulation, saving or release and does not add theme-song/titantron scope.
...
foundation are merged, with WM-021.1 landing through PR #5 at `28f6a26`. See its
[canonical search rules](search-and-discovery-rules.md). WM-025 is implemented, review-fixed and
verified locally; an authorised commit remains. Decision-complete WM-024 is next after it lands.
...
|              14 | WM-021 | Talent Search foundation — WM-021.1 merged; final ring-identity integration follows WM-025         | WM-020, WM-022–023; WM-025 for full exit               | Merged through PR #5  | foundation     |
|              15 | WM-025 | Person/Character separation, ring identities, gimmicks, masks and alignment — review-fixed locally | WM-022–023, PD-106                                     | Sol/Medium            | Commit pending |
|              16 | WM-024 | FM-inspired Person profile, career and action hub                                                  | WM-020–023, WM-025, PD-133                             | Sol/High              | 2–4 wk         |
...
|              37 | WM-043 | Optional PlayCanvas v2 retro 3D broadcast and main move-family engine                              | WM-013–014; later WM-007, WM-029, WM-034, WM-041       | Sol/High              | 26–39 wk core  |
...
|              39 | WM-016 | Cohesive WM visual identity and complex-screen design system                                       | WM-014, WM-035                                         | Sol/High              | 3–5 wk         |
|              40 | WM-017 | Full management navigation, context menus and accessible workflows                                 | WM-016                                                 | Terra/High            | 3–5 wk         |
...
|              42 | WM-041 | Native database editor, scenario import/export and optional asset packs                            | Stable IDs continuously; public tools after WM-015–018 | Sol/High              | 4–7 wk         |
...
| Conditional retro 3D broadcast core         | WM-043                         |                   26–39 weeks |
| Hardening, interface, modding and release   | WM-015–019, WM-041             |                   19–32 weeks |
| **Core plan total**                         | **WM-002–042**                 | **115–198 engineering weeks** |
| **With optional WM-043 core**               | **WM-002–043**                 | **141–237 engineering weeks** |
...
estimate buckets, governs delivery and integration. WM-043's 26–39 weeks is the main move-family/show
engine after a successful spike; broad release-quality 3D polish is currently estimated at 52–78 weeks
and is not included in the core-plan total.
